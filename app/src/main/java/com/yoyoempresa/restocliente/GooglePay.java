...
public class GooglePay {
     ...
     */
    private static JSONObject getTransactionInfo(Double precio) throws JSONException {
        JSONObject transactionInfo = new JSONObject();
        String precio_final = String.valueOf(precio);
        transactionInfo.put("totalPrice", precio_final);
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.N)
    public static Optional<JSONObject> getPaymentDataRequest(Double precio) {
        try {
            ...
            paymentDataRequest.put("transactionInfo", GooglePay.getTransactionInfo(precio));
